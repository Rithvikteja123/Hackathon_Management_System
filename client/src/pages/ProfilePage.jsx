    ...
    <DashboardLayout>
      <div className="max-w-5xl mx-auto space-y-8 py-2">
        ...
        <motion.div
          ...
          className="relative rounded-2xl border border-zinc-200 bg-white overflow-hidden shadow-md"
        >
          {/* Header Banner Background */}
          <div className="h-32 bg-gradient-to-r from-zinc-100 via-zinc-200 to-zinc-100 border-b border-zinc-200 relative overflow-hidden">
            <div className="blob w-64 h-64 bg-black/5 -top-20 -left-20" />
          ...
          <div className="px-6 pb-6 pt-0 relative z-10 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 -mt-12">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-5">
              <div className="w-24 h-24 rounded-full bg-black border-4 border-white overflow-hidden flex items-center justify-center shadow-lg flex-shrink-0">
                {user?.avatar ? (
              ...
              <div>
                ...
                <p className="text-zinc-600 text-xs mt-1 flex items-center gap-1.5">
                  <HiOutlineMail className="text-zinc-400" />
                  {user?.email}
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className={`btn-secondary text-xs px-4 py-2 flex items-center gap-1.5 transition-all ${
                editing ? "border-red-200 text-red-600 hover:bg-red-50" : ""
              }`}
            >
              {editing ? (
                <>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          >
            ...
            <div className="card space-y-3">
              <h3 className="text-sm font-bold text-black uppercase tracking-wider flex items-center gap-2 border-b border-zinc-200 pb-2.5">
                <HiOutlineUser className="text-zinc-500" /> About Developer
              </h3>
            ...
            <div className="card space-y-3">
              <h3 className="text-sm font-bold text-black uppercase tracking-wider flex items-center gap-2 border-b border-zinc-200 pb-2.5">
                <HiOutlineCode className="text-zinc-500" /> Skills & Tech Stack
              </h3>
            ...
            <div className="card space-y-3">
              <h3 className="text-sm font-bold text-black uppercase tracking-wider flex items-center gap-2 border-b border-zinc-200 pb-2.5">
                <HiOutlineGlobeAlt className="text-zinc-500" /> Developer Profiles
              </h3>
              <div className="space-y-2.5 text-xs">
                {user?.github ? (
                  <a
                    ...
                    className="flex items-center gap-2.5 p-2 rounded-lg bg-zinc-50 border border-zinc-200 text-zinc-800 hover:text-black hover:border-zinc-300 transition-colors truncate"
                  >
                    <FaGithub className="text-sm flex-shrink-0 text-black" />
                ...
                {user?.linkedin ? (
                  <a
                    ...
                    className="flex items-center gap-2.5 p-2 rounded-lg bg-zinc-50 border border-zinc-200 text-zinc-800 hover:text-black hover:border-zinc-300 transition-colors truncate"
                  >
                    <FaLinkedin className="text-sm flex-shrink-0 text-blue-600" />
                ...
                {user?.portfolio ? (
                  <a
                    ...
                    className="flex items-center gap-2.5 p-2 rounded-lg bg-zinc-50 border border-zinc-200 text-zinc-800 hover:text-black hover:border-zinc-300 transition-colors truncate"
                  >
                    <HiOutlineGlobeAlt className="text-sm flex-shrink-0 text-emerald-600" />
          ...
          >
            {/* Edit Profile Form */}
            {editing ? (
              <form onSubmit={handleSave} className="card space-y-4 border-zinc-300">
                <div className="flex items-center justify-between border-b border-zinc-200 pb-3">
                  <h3 className="text-sm font-bold text-black uppercase tracking-wider flex items-center gap-2">
                    <HiOutlinePencil className="text-black" /> Edit Developer Details
                  </h3>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="input-field bg-white border-zinc-200 focus:border-black text-black"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="input-field bg-white border-zinc-200 focus:border-black resize-none text-xs text-black"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="input-field bg-white border-zinc-200 focus:border-black text-xs text-black"
                  />
                </div>
            ...
            <form onSubmit={handleChangePassword} className="card space-y-4">
              <h3 className="text-sm font-bold text-black uppercase tracking-wider flex items-center gap-2 border-b border-zinc-200 pb-2.5">
                <HiOutlineLockClosed className="text-zinc-500" /> Account Security & Password
              </h3>
