        ...
        <div className="flex items-center justify-between border-b border-zinc-200 pb-3">
          <div>
            <h1 className="text-xl font-extrabold text-black flex items-center gap-2">
              <HiOutlineSparkles className="text-black" /> Platform Organizers
            </h1>
            <p className="text-zinc-600 text-xs mt-0.5">Manage all hackathon organizers and event managers</p>
          </div>
            ...
            <table className="data-table text-xs">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={4} className="text-center text-zinc-600 py-10 font-semibold">No organizers found</td></tr>
                ) : (
                  users.map(u => (
                    <tr key={u._id}>
                      <td>
