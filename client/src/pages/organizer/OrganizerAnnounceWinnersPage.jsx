        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200 pb-4">
          <div>
            <h1 className="text-2xl font-extrabold text-black tracking-tight flex items-center gap-2">
              <RiTrophyLine className="text-black" /> Announce Hackathon Winners
            </h1>
              ...
              {leaderboard.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0 bg-zinc-50 border border-zinc-200 px-4 py-2 rounded-xl">
                      <div>
                        <p className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">Avg Score</p>
                        <p className="text-lg font-black text-amber-700">{item.averageScore} <span className="text-xs font-semibold text-zinc-500">pts</span></p>
                      </div>
                      <div className="h-6 w-px bg-zinc-200" />
                      <div>
                        <p className="text-[10px] text-zinc-500 uppercase font-bold tracking-wider">Evaluations</p>
                        <p className="text-sm font-bold text-zinc-700">{item.reviewCount} judge{item.reviewCount !== 1 ? "s" : ""}</p>
                      </div>
                    </div>
