      ...
      <div className="space-y-6 max-w-4xl">
        <div className="border-b border-zinc-200 pb-4">
          <h1 className="text-2xl font-extrabold text-black tracking-tight flex items-center gap-2">
            <HiOutlineClipboardList className="text-black" /> Completed Reviews
          </h1>
          <p className="text-zinc-600 text-xs mt-1">All submissions you have already scored</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="empty-state py-16 card">
            ...
            <p className="text-zinc-600 text-sm mt-2 font-semibold">No completed reviews yet</p>
              ...
              <tbody>
                {reviews.map(r => (
                  <tr key={r._id}>
                    ...
                    <td className="text-zinc-700 text-sm font-medium">
                      {r.hackathon?.title || "—"}
                    </td>
                    <td>
